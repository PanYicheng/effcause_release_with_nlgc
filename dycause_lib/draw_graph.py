...
def draw_alldata(data, data_head, filepath):
    """Draw all metric data within one figure.

    Args:
        data (numpy array): metric data in 2d matrix, [T, N].
        data_head (list of str): name of each metric.
        filepath (str): path for saving the figure.
    """
    fig = plt.figure(1)
