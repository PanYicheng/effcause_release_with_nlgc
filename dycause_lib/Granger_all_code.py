# -*- coding: utf-8 -*-
"""
Created on Sat Jun  4 19:48:18 2016. The original 
Granger causal intervals code from the paper 
`SDM17-Li-Discovery of Causal Time Intervals`.
...
def loop_granger(array_data, array_data_head, path_to_output, feature, target,
    ...
    if verbose:
        ...
        print('Prune for X <-- Y:\n', ' '*5, cnt_prune_XY)
    if return_result:
        return total_time, time_OLS, time_granger, time_adf, array_results_YX, array_results_XY
    return total_time, time_OLS, time_granger, time_adf
